...
;[button graphic="camerabutton.png" target="camerapoint" width="100" height="100" x="40" y="40" name="camerabutton" layer="1"]
...
;[free name="camerabutton" layer="1"]

;[bgcamera mode="back" fit="true" qrcode="all" left="0" top="216" width="720" height="680"]

;[button graphic="closebutton.png" target="mission_start" width="100" height="100" x="40" y="256" name="closebutton" layer="1"]
